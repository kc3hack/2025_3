...
const initialLandmarks: Landmark[] = [
  ...
  {height: 110.0, markpoint: -1,  name:"a",prefecture:"a",description:"aa",img_path:"./"},
  {height: 120.0, markpoint: -1,  name:"i",prefecture:"a",description:"aa",img_path:"./"},
  {height: 130.0, markpoint: 5,   name:"u",prefecture:"a",description:"aa",img_path:"./"},
  {height: 140.0, markpoint: -1,  name:"e",prefecture:"a",description:"aa",img_path:"./"},
  {height: 150.0, markpoint: -1,  name:"o",prefecture:"a",description:"aa",img_path:"./"},
  {height: 160.0, markpoint:  6,  name:"ka",prefecture:"a",description:"aa",img_path:"./"},
